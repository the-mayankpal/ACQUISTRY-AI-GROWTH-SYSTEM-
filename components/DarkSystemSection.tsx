          ...
          <div className="relative z-10 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 text-left">
              <div className="space-y-2 md:space-y-3">
                <span className="material-symbols-outlined text-[#0066ff] text-3xl" aria-hidden="true">hub</span>
                <h3 className="font-bold text-white">Growth System</h3>
                <p className="text-xs md:text-sm text-gray-400">End-to-end automation of your acquisition funnel.</p>
              </div>
              <div className="space-y-2 md:space-y-3">
                <span className="material-symbols-outlined text-[#0066ff] text-3xl" aria-hidden="true">psychology</span>
                <h3 className="font-bold text-white">Market Research</h3>
                <p className="text-xs md:text-sm text-gray-400">Deeper insights into niche profitability and pain points.</p>
              </div>
              <div className="space-y-2 md:space-y-3">
                <span className="material-symbols-outlined text-[#0066ff] text-3xl" aria-hidden="true">rocket_launch</span>
                <h3 className="font-bold text-white">Outbound & Replies</h3>
                <p className="text-xs md:text-sm text-gray-400">Scale without losing the personal touch in conversations.</p>
              </div>
              <div className="space-y-2 md:space-y-3">
                <span className="material-symbols-outlined text-[#0066ff] text-3xl" aria-hidden="true">query_stats</span>
                <h3 className="font-bold text-white">Calls & Optimization</h3>
          ...
          <div className="relative mt-8 lg:mt-0" aria-hidden="true">
            ...
            <div className="relative bg-[#1a2432] p-6 md:p-10 rounded-3xl border border-white/10 shadow-2xl">
              <div className="space-y-4 md:space-y-5">
                <div className="flex items-center gap-3 md:gap-4 bg-white/5 p-4 md:p-5 rounded-xl border border-white/5">
                  <div className="shrink-0 w-2.5 h-2.5 rounded-full bg-green-400 animate-pulse"></div>
                  <div className="text-xs md:text-sm font-mono text-gray-300">Searching leads in Fintech sector...</div>
                </div>
                <div className="flex items-center gap-3 md:gap-4 bg-white/5 p-4 md:p-5 rounded-xl border border-white/5">
                  <div className="shrink-0 w-2.5 h-2.5 rounded-full bg-[#0066ff] animate-pulse"></div>
                  <div className="text-xs md:text-sm font-mono text-gray-300">Drafting 142 hyper-personalized emails...</div>
                </div>
                <div className="flex items-center gap-3 md:gap-4 bg-white/10 p-4 md:p-5 rounded-xl border-[#0066ff]/30 border-2 shadow-lg scale-[1.02]">
                  <div className="shrink-0 w-2.5 h-2.5 rounded-full bg-[#0066ff]"></div>
